...
DATABASE_NAME = 'badgerdb'             # Or path to database file if using sqlite3.
DATABASE_USER = 'makyo'             # Not used with sqlite3.
DATABASE_PASSWORD = 'Gaf%fs43'         # Not used with sqlite3.
DATABASE_HOST = 'badgersql.mjs-svc.com'             # Set to empty string for localhost. Not used with sqlite3.
...
MEDIA_ROOT = '/home/makyo/media.mjs-svc.com/badger/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path component (optional in other cases).
# Examples: "http://media.lawrence.com", "http://example.com/media/"
MEDIA_URL = 'http://media.mjs-svc.com/badger/'
